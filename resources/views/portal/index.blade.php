                ...
                <ul class="main-products-items">
                    <li class="main-products-item main-products-item-1">
                        <div class="main-products-item-link">
                            <img src="../img/templates/main-products/main-product-5.png" alt="Государственные учреждения">
                        </div>
                    </li>
                    ...
                    <li class="main-products-item main-products-item-2">
                        <div class="main-products-item-link">
                            <img src="../img/templates/main-products/main-product-2.png" alt="Образовательные учреждения">
                        </div>
                    </li>
                    <li class="main-products-item">
                        <img src="../img/templates/main-products/main-product-line.png"
                    ...
                    <li class="main-products-item main-products-item-3">
                        <div class="main-products-item-link">
                            <img src="../img/templates/main-products/main-product-1.png" alt="Жилые комплексы">
                        </div>
                    </li>
                    <li class="main-products-item">
                        <img src="../img/templates/main-products/main-product-line.png"
                    ...
                    <li class="main-products-item main-products-item-4">
                        <div class="main-products-item-link">
                            <img src="../img/templates/main-products/main-product-8.png" alt="Розничная торговля">
                        </div>
                    </li>
                    <li class="main-products-item">
                        <img src="../img/templates/main-products/main-product-line.png"
                    ...
                    <li class="main-products-item main-products-item-5">
                        <div class="main-products-item-link">
                            <img src="../img/templates/main-products/main-product-6.png" alt="Транспорт и логистика">
                        </div>
                    </li>
                    <li class="main-products-item">
                        <img src="../img/templates/main-products/main-product-line.png"
                    ...
                    <li class="main-products-item main-products-item-6">
                        <div class="main-products-item-link">
                            <img src="../img/templates/main-products/main-product-4.png" alt="Производственные компании">
                        </div>
                    </li>
                    <li class="main-products-item">
                        <img src="../img/templates/main-products/main-product-line.png"
                    ...
                    <li class="main-products-item main-products-item-7">
                        <div class="main-products-item-link">
                            <img src="../img/templates/main-products/main-product-7.png" alt="Частыне домовладения">
                        </div>
                    </li>
                </ul>
            </div>
