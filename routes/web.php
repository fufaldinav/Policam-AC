...
Route::group(['prefix' => 'controllers', 'as' => 'controllers.'], function () {
    ...
    Route::group(['prefix' => 'cmd', 'as' => 'cmd.'], function () {
        ...
        Route::get('reboot/{controller_sn}/{device?}', 'ControllersController@reboot');
        Route::get('reset/{controller_sn}/{device?}', 'ControllersController@reset');
        Route::get('clear_eeprom/{controller_sn}/{device?}', 'ControllersController@clearEeprom');
        Route::get('clear_messages/{controller_sn}/{device?}', 'ControllersController@clearMessages');
        Route::get('clear_cards/{controller_sn}/{device}', 'ControllersController@clearCards');
        Route::get('clear_events/{controller_sn}/{device?}', 'ControllersController@clearEvents');
        Route::get('clear_messages_bl/{controller_sn}', 'ControllersController@clearMessagesBlacklist');
...
//        Route::get('address/{value}/{controller_sn}/{device}', 'ControllersController@address');
        ...
        Route::get('door_sensors/{value}/{controller_sn}/{device}', 'ControllersController@doorSensors');
        Route::get('door_open_timeout/{value}/{controller_sn}/{device}', 'ControllersController@doorOpenTimeout');
